export const introTextKorean = {
  firstIntrofirstLine: `Leaders of GEOINT`,
  firstIntroSecondLine: `로딕스는 특수분야의 사업수행 경험을 바탕으로
  센서기반 공간정보 응용 솔루션 개발, GIS 솔루션 시장, GIS DB 구축 사업을 추진합니다.`,
  secondIntroFirstLine: `GEOINT 전문기업`,
  secondIntroSecondLine: `공공 및 민간부분의 GEOINT 시장 창출과 확장을 선도하는 강소기업입니다.`,
};
